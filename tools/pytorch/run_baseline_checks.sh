#!/usr/bin/env bash
#
# Baseline check process for the pytorch image. Run this against a
# freshly built image (or any environment with python3, jupyter, and conda on
# PATH) whenever a new version of the image is created.
#
# Usage:
#   docker run --rm pytorch:<tag> \
